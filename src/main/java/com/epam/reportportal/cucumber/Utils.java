...
public class Utils {
	...
	public static String startLaunch() {
		...
		try {
			...
			ListenersUtils.handleException(e, LOGGER, "Cannot start the launch: '" + listenerParameters.get().getLaunchName() + "'");
		}
		return id;
	}
	...
	public static String startNonLeafNode(String launchId, String rootItemId, String name, String description, List<Tag> tags,
			String type) {
